...
\item $N=\{(0,0),(2,0)\}$, so $|N|=2$ and $|G/N|=8/2=4$. $G/N$ is abelian of order 4. The coset of $(1,0)$ has order $4/\gcd(1, \text{relevant})$... Let us check: $(1,0)+N$ has order: we need the smallest $k$ with $k(1,0)\in N$. $k(1,0)=(k\bmod 4,0)$; this is in $N=\{(0,0),(2,0)\}$ when $k\equiv 0$ or $2\pmod{4}$, so the smallest positive $k$ is 2. Thus $(1,0)+N$ has order 2. Similarly $(0,1)+N$ has order 2. Since $G/N$ has order 4 and every non-identity element has order 2, $G/N\cong V_4\cong\mathbb{Z}/2\mathbb{Z}\times\mathbb{Z}/2\mathbb{Z}$.
